...
Builder.load_file("./widgets/completed_audit_page.kv")
Builder.load_file("./widgets/completed_audits_list_page.kv")
Builder.load_file("./widgets/auditor_completed_audit_page.kv")
